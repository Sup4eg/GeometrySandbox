...
void AGeometryHubActor::OnTimerFinished(AActor* Actor)
{
  ...
  if (!Geometry) return;
  UE_LOG(LogGeometryHub, Display, TEXT("Cast is success, amplitude %f\n"), Geometry->GetGeometryData().Amplitude);
  UE_LOG(LogGeometryHub, Display, TEXT("%s"), *Geometry->toStringGeometryData());
